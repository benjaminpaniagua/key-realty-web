  ...
  return (
    <div className="flex h-full flex-col justify-center p-6 lg:p-10 gap-4">
      <div className="flex flex-col gap-2">
        <h3 className="text-2xl font-semibold text-white">Do you want contact me?</h3>
        <p className="text-base text-white">Im open to collaborations and new challenges.</p>
      </div>
